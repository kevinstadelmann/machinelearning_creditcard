...
#df.r.squared.gam <- transpose(base::data.frame(r.squared.results.gam))
#base::colnames(df.r.squared.gam) <- c("gam.1", "gam.2", "gam.3")
...
```
In the boxplot it can be seen that the R squared of the most complex model with six variables has the highest median. The adjusted R squared in this model also has the highest value. The adjusted R squared in this model also has the highest value, which means that we have a slightly better model than the others despite the higher number of variables. Overall, it should be noted that R squared, respectively R squared adjusted is very low suggesting very limited predictive power of these models.
