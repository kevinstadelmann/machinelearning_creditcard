...
`Dependen var` <- c('percentage_good', 'cnt_status_good','', '','customer_status_good', '')
Model <- c('percent_good ~ occupation_type','cnt_status_good ~ occupation_type (quasi-poisson)','','','customer_status_good ~ amt_income_total + flag_own_realty', '')
Performance <- c('', '', '', '', '', '')

table <- data.frame(Method, `Dependen var`, Model, Performance)
table
```
